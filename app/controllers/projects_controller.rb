...
class ProjectsController < ApplicationController
  ...
  def bitly
    ...
    require 'net/http'
    res = Net::HTTP.start("api.bit.ly", 80) { |http| http.get("/v3/shorten?login=diogob&apiKey=R_2ba4fd974ddbfe4fe60c997860a9a3f8&longUrl=#{CGI.escape(project_url(@project))}") }
