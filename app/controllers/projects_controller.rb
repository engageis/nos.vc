...
class ProjectsController < ApplicationController
  ...
  def bitly
    ...
    require 'net/http'
    res = Net::HTTP.start("api.bit.ly", 80) { |http| http.get("/v3/shorten?login=diogob&apiKey=R_5fe82290be618f624100373d35e8c75e&longUrl=#{CGI.escape(project_url(@project))}") }
